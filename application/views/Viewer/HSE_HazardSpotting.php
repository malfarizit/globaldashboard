...
<a class="btn btn-primary" href="<?php echo base_url(); ?>Main/hse_hazardspotting" role="button">HSE Hazard Spotting</a>
<a class="btn btn-info" href="<?php echo base_url(); ?>Main/HSE_LeadingLagging" role="button">HSE Leading & Lagging</a></center>
...
<section class="col-lg-12 connectedSortable">  
  ...
  <div id="reportContainer" class="dds__d-none" style="height:804px; overflow-y:hidden">
    <iframe id="reportFrame" onload="powerBiLoaded()" frameborder="0" seamless="seamless" class="viewer pbi-frame" style=" width: 100%; height: 840px;" src="https://app.powerbi.com/view?r=eyJrIjoiN2MzZDlhYWYtNzllYy00YWU5LWEyZTUtNGNmOWQxNTk2MzA3IiwidCI6ImVmNzI2YmJkLWZhOTYtNDNmOS1hZmMxLTZjMDc5ZDk2YmQ5MSIsImMiOjEwfQ%3D%3D">
    </iframe>
</div>
  </div> 
</section>
...
<section class="col-lg-12 connectedSortable">  
  ...
  <div id="reportContainer" class="dds__d-none" style="height:804px; overflow-y:hidden">
    <iframe id="reportFrame" onload="powerBiLoaded()" frameborder="0" seamless="seamless" class="viewer pbi-frame" style=" width: 100%; height: 840px;" src="https://app.powerbi.com/view?r=eyJrIjoiMzA1ZDUyNjctODY1OC00MzQ4LWFhODUtZWFlYWNlMjEwODYyIiwidCI6ImVmNzI2YmJkLWZhOTYtNDNmOS1hZmMxLTZjMDc5ZDk2YmQ5MSIsImMiOjEwfQ%3D%3D">
    </iframe>
</div>
  </div> 
</section>
