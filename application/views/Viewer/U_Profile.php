<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('main/U_Profile',$attributes);             
          echo "<div class='col-md-12 table-responsive'>
                  <table class='table table-striped table-bordered table-responsive'>
					<tbody class='tbody-responsive'> 
						...
						<tr><th scope='row'>Email</th>                
							<td>
								<input type='email' class='form-control' name='c' value='$rows[Email]' readonly='on'> 
							</td>
						</tr>
						<tr><th scope='row'>No Hp</th>           
							<td>
								<input type='tel' class='form-control' name='d' value='$rows[No_Hp]'readonly='on'>
							</td>
						</tr>
						...
						<tr><th scope='row'>Change Image</th>            
							<td>
								<input type='file' class='form-control' name='g' id='g'>
							</td>
						</tr> 						
					</tbody>
                  </table>
				...
				<div class='box-footer'> 
					...
					<a href='..\V_ActionPlan'><button type='button' class='btn btn-default pull-right'>Cancel</button></a> 	
				</div>
              </div>
			 </div>
			</div>";
