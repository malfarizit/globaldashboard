<center><a class="btn btn-primary" href="<?php echo base_url(); ?>Main/hse" role="button">HSE Statistic Dashboard</a>
...
<section class="col-lg-12 connectedSortable">  
  <div class='box' style='min-height:250px;'>
    ...
    <center><a class="btn btn-success" href="https://drive.google.com/drive/folders/1xWjJd-OJEEEXfH8IGxF3KBgRugz4pIl1" role="button"><i class="fa fa-database"></i> Global HSE Data Control</a></center>  
	<!-- <div class="container" style="width: 100%; height: 60%;">
