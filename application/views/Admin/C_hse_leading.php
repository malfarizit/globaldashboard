          ...
          echo "<div class='col-md-12'>
			...
			<div class="box">
			  <div class="box-header">
				<h3 class="box-title">HSE Leading Indicator</h3>
				  ...
				  <tbody>
					...
					$no = 1; 
					  ...
					  echo "<tr>
							  ...
							  echo "<td><center>
									  <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."Main/D_hse_leading/$row[id]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
								  </center></td>";
							  }							
					  echo "</tr>";
					  $no++;
