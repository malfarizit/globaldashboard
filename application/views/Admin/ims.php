...
<div class="dropdown center-block " style="margin-left: 44%;">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="https://docs.google.com/spreadsheets/d/1EccWHuoTANXqkadMibBMGcLb9O3VYZu-f1kJcn8io_M/" target="_blank">Global</a></li>
...
<section class="col-lg-12 connectedSortable">  
  <div class='box' style='min-height:250px;'>
    <div class='box-header'>
      <center><h3 class='box-title'>IMS Desktop View</h3></center>
    </div>  
...
<section class="col-lg-12 connectedSortable">  
  <div class='box' style='min-height:250px;'>
    <div class='box-header'>
      <center><h3 class='box-title'>IMS Mobile View</h3></center>
    </div>  
	<!-- <div class="container" style="width: 100%; height: 60%;">
